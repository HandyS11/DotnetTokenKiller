...
/// <summary>Runs dotnet pack with filtered output.</summary>
/// <param name="filteredRun">The filtered run use case.</param>
/// <param name="filter">The pack output filter.</param>
internal sealed class DotnetPackCommand(
    FilteredRunUseCase filteredRun,
    [FromKeyedServices(FilterKeys.Pack)] IOutputFilter filter) : AsyncCommand<DotnetCommandSettings>
{
    /// <inheritdoc/>
