...
internal static class HookScriptTemplates
{
    ...
    private static readonly string GeminiHeader = $$""""
        #!/usr/bin/env python3
        """Gemini CLI BeforeTool hook: rewrites `dotnet {{SubcommandAlternation}}` to `dtk dotnet ...`.
    ...
    private static readonly string CopilotCliHeader = $$""""
        #!/usr/bin/env python3
        """GitHub Copilot CLI preToolUse hook: rewrites `dotnet {{SubcommandAlternation}}` to `dtk dotnet ...`.
