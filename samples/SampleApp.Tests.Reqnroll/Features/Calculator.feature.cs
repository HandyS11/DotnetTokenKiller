...
namespace SampleApp.Tests.Reqnroll.Features
{
    ...
    public partial class CalculatorFeature : object, Xunit.IClassFixture<CalculatorFeature.FixtureData>, Xunit.IAsyncLifetime
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features", "Calculator", "  A simple calculator for demonstrating Reqnroll BDD test output.", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
            ...
            else
            {
                await this.ScenarioStartAsync();
#line 11
    await testRunner.GivenAsync("the first number is 100", ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
#line hidden
#line 12
    await testRunner.AndAsync("the second number is 30", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
#line 13
    await testRunner.WhenAsync("the second number is subtracted from the first", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 14
    await testRunner.ThenAsync("the result should be 70", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Division by zero should fail")]
        [Xunit.TraitAttribute("FeatureTitle", "Calculator")]
        [Xunit.TraitAttribute("Description", "Division by zero should fail")]
        public async global::System.Threading.Tasks.Task DivisionByZeroShouldFail()
        {
            string[] tagsOfScenario = ((string[])(null));
            global::System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new global::System.Collections.Specialized.OrderedDictionary();
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Division by zero should fail", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 22
  this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((global::Reqnroll.TagHelper.ContainsIgnoreTag(scenarioInfo.CombinedTags) || global::Reqnroll.TagHelper.ContainsIgnoreTag(featureTags)))
            ...
            else
            {
                await this.ScenarioStartAsync();
#line 23
    await testRunner.GivenAsync("the first number is 10", ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
#line hidden
#line 24
    await testRunner.AndAsync("the second number is 0", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
#line 25
    await testRunner.WhenAsync("the first number is divided by the second", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 26
